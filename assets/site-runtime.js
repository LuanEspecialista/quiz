(async function () {
  ...
  css.textContent = ".luan-language{position:fixed;right:14px;top:max(12px,calc(var(--luan-quote-height, 0px) + env(safe-area-inset-top)));z-index:2147483646;font-family:Inter,Arial,sans-serif}.luan-language-toggle{min-width:46px;min-height:36px;display:flex;align-items:center;justify-content:center;gap:5px;padding:7px 9px;border:1px solid rgba(197,160,89,.42);border-radius:999px;background:rgba(10,10,10,.9);color:#e7be73;font:700 11px/1 Inter,Arial,sans-serif;cursor:pointer;backdrop-filter:blur(8px);box-shadow:0 5px 18px rgba(0,0,0,.28)}.luan-language-menu{position:absolute;top:calc(100% + 7px);right:0;min-width:142px;display:grid;gap:2px;padding:4px;border:1px solid rgba(197,160,89,.32);border-radius:10px;background:#111;box-shadow:0 12px 30px rgba(0,0,0,.48)}.luan-language-menu[hidden]{display:none!important}.luan-language-option{width:100%;padding:9px 10px;border:0;border-radius:7px;background:transparent;color:#ddd;text-align:left;font:600 11px/1.2 Inter,Arial,sans-serif;cursor:pointer}.luan-language-option[aria-checked=true]{background:#c5a059;color:#090909}.luan-rate-note{font:10px/1.35 Inter,Arial,sans-serif;color:rgba(255,255,255,.48);text-align:center;margin:10px auto;max-width:720px}.luan-blocked{min-height:100vh;display:grid;place-items:center;background:#070707;color:#eee}";
