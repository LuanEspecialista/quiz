...
import { Building2, Check, Clipboard, Copy, Layers3, ShieldCheck } from "lucide-react";
...
export default function PromptsModule() {
  ...
  return <section style={{ maxWidth: 1120, margin: "0 auto", display: "grid", gap: 22 }}>
    <header>
      ...
      <h1 style={{ margin: "7px 0", fontSize: 28 }}>Prompts de cadastro</h1>
      <p style={{ margin: 0, color: "#9696a1", maxWidth: 760, lineHeight: 1.55 }}>Copie o modelo adequado, envie junto com o PDF para a IA e use o JSON resultante no Importar IA. Os prompts exigem conferência, rastreabilidade e proíbem preenchimentos inventados.</p>
    </header>
