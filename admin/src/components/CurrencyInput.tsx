...
export default function CurrencyInput({ value, onChange, placeholder = "R$ 0,00", style, disabled, ariaLabel }: { value: number; onChange: (value: number) => void; placeholder?: string; style?: CSSProperties; disabled?: boolean; ariaLabel?: string }) {
  return <input
    type="text"
    inputMode="numeric"
