import{r as e}from"./rolldown-runtime-hePW80VL.js";import{Bt as t,S as n,Ut as r,Zt as i,jt as a,tt as o,u as s,xt as c,yt as l}from"./vendor-icons-Cgl4yo3e.js";import{t as u}from"./vendor-react-DpDwJYYe.js";import{t as d}from"./blogEditorial--nBI5yFz.js";var f=e(i(),1),p=u(),m=`Você é um auditor de tabelas imobiliárias. Analise integralmente o PDF ou imagem anexado e transforme a tabela de vendas em dados estruturados, sem inventar, completar por suposição ou arredondar valores.
...
16. Coloque em unidades somente registros com identificacao.numero e comercial.valor_tabela numérico maior que zero. Linhas reais sem algum desses campos devem ir para unidades_pendentes, preservando o restante e explicando a ausência em comercial.observacoes.
...
21. Para empreendimentos grandes ou multitorres, processe apenas a torre solicitada por vez. Nunca misture uma parte da Torre 1 com uma parte da Torre 2 para reduzir o tamanho da resposta.
22. Preencha lote_importacao. Em escopo "torre", todas as unidades e pendências devem pertencer exatamente à torre informada. O resumo e a validação devem contar somente esse lote, salvo quando o documento imprimir explicitamente um resumo geral; nesse caso, registre o resumo geral nos alertas e não o use para invalidar a contagem do lote.
...
Responda com um único bloco JSON válido, sem markdown, comentários ou reticências, neste formato:
{
  ...
  "lote_importacao": { "escopo": "empreendimento", "torre": null, "lote_atual": 1, "total_lotes": 1, "completo_no_escopo": true },
...
Antes de responder, confira novamente a contagem de linhas, códigos repetidos, torres e totais financeiros. resumo_oficial deve reproduzir os números impressos, sem ser recalculado a partir do array. A soma de unidades + unidades_pendentes deve fechar exatamente com o resumo do escopo processado. Use PRONTO_PARA_IMPORTAR quando existir ao menos uma unidade válida e todas as contagens estiverem conciliadas; preserve linhas reais incompletas em unidades_pendentes. Use PENDENTE_INFORMACAO quando a contagem não fechar, nenhuma unidade puder ser importada ou uma dúvida global impedir interpretar o documento.`,h=`Você é um auditor técnico de memoriais, apresentações e materiais comerciais imobiliários. Analise integralmente todos os PDFs ou imagens anexados e estruture o empreendimento sem inventar informações.
...
Antes de responder, faça uma segunda leitura para conferir números, nomes próprios, datas, contagens, áreas e registro de incorporação. Não resuma listas e nunca devolva apenas exemplos.`,g=`Você é um estrategista de conteúdo imobiliário e auditor de informações. Analise integralmente a apresentação da construtora e transforme somente o que estiver comprovado no material em conteúdo persuasivo para uma landing page de vendas.
...
Use layout_sugerido editorial, imersivo ou investidor. Releia o material e remova afirmações que não sejam sustentadas pela apresentação.`,_=`Você é um analista comercial e auditor de materiais. Leia integralmente o book/apresentação e a tabela anexados e crie um Kit do Indicador. O indicador apenas identifica interesse e encaminha o contato; ele não anuncia, negocia condições, recebe valores nem se apresenta como corretor.
...
{"tipo":"imovel","empreendimento_id":null,"codigo":"IMO-001","titulo":"Oportunidade residencial no litoral","cidade":null,"regiao_aproximada":null,"faixa_preco_min":null,"faixa_preco_max":null,"resumo":"","publico_ideal":[],"diferenciais":[],"perguntas":[],"objecoes":[{"objecao":"","resposta":""}],"roteiro":"","cuidados":"","imagem_ids":[],"ativo":false,"validacao":{"fontes":[{"pagina":null,"informacao":""}],"alertas":[],"campos_nao_confirmados":[]}};function v({title:e,description:t,prompt:n,icon:r,copied:i,onCopy:o}){return(0,p.jsxs)(`article`,{style:{background:`#101012`,border:`1px solid #26262b`,borderRadius:12,padding:22,display:`grid`,gap:16},children:[(0,p.jsxs)(`div`,{style:{display:`flex`,gap:12,alignItems:`flex-start`},children:[(0,p.jsx)(`div`,{style:{width:42,height:42,borderRadius:10,background:`rgba(213,164,87,.12)`,color:`#d5a457`,display:`grid`,placeItems:`center`,flex:`0 0 auto`},children:(0,p.jsx)(r,{size:21})}),(0,p.jsxs)(`div`,{children:[(0,p.jsx)(`h2`,{style:{margin:0,fontSize:18},children:e}),(0,p.jsx)(`p`,{style:{margin:`6px 0 0`,color:`#92929d`,lineHeight:1.5,fontSize:13},children:t})]})]}),(0,p.jsx)(`div`,{style:{padding:`12px 14px`,borderRadius:8,background:`#0a0a0b`,border:`1px solid #202024`,color:`#777782`,fontSize:12,lineHeight:1.55,height:112,overflow:`hidden`,whiteSpace:`pre-wrap`,maskImage:`linear-gradient(#000 55%, transparent)`},children:n}),(0,p.jsxs)(`button`,{onClick:o,style:{height:42,border:i?`1px solid #218b57`:`1px solid #8e672e`,borderRadius:8,background:i?`#123021`:`#d5a457`,color:i?`#76dfa8`:`#080808`,fontWeight:800,cursor:`pointer`,display:`flex`,justifyContent:`center`,alignItems:`center`,gap:8},children:[i?(0,p.jsx)(a,{size:17}):(0,p.jsx)(l,{size:17}),i?`Prompt copiado`:`Copiar prompt completo`]})]})}function y(){let[e,i]=(0,f.useState)(null),[a,u]=(0,f.useState)(``),y=async(e,t)=>{if(navigator.clipboard?.writeText)await navigator.clipboard.writeText(t);else{let e=document.createElement(`textarea`);e.value=t,e.style.position=`fixed`,e.style.opacity=`0`,document.body.appendChild(e),e.select(),document.execCommand(`copy`),e.remove()}i(e),window.setTimeout(()=>i(t=>t===e?null:t),2200)};return(0,p.jsxs)(`section`,{style:{maxWidth:1120,margin:`0 auto`,display:`grid`,gap:22},children:[(0,p.jsxs)(`header`,{children:[(0,p.jsx)(`div`,{style:{color:`#d5a457`,textTransform:`uppercase`,letterSpacing:`.12em`,fontSize:11,fontWeight:800},children:`Inteligência de importação`}),(0,p.jsx)(`h1`,{style:{margin:`7px 0`,fontSize:28},children:`Central de Prompts`}),(0,p.jsx)(`p`,{style:{margin:0,color:`#9696a1`,maxWidth:760,lineHeight:1.55},children:`Use modelos preparados para entregar ao sistema exatamente a estrutura esperada, sem preenchimento manual repetitivo.`})]}),(0,p.jsxs)(`div`,{style:{display:`flex`,gap:9,alignItems:`center`,color:`#8fa695`,background:`#0e1712`,border:`1px solid #1e3b2a`,borderRadius:9,padding:`11px 14px`,fontSize:12},children:[(0,p.jsx)(n,{size:17}),` O resultado ainda deve ser revisado antes da importação quando o PDF estiver borrado, cortado ou tiver cálculos divergentes.`]}),(0,p.jsxs)(`div`,{style:{display:`grid`,gridTemplateColumns:`repeat(auto-fit, minmax(330px, 1fr))`,gap:16},children:[(0,p.jsx)(v,{title:`Prompt de Unidades`,description:`Para tabelas de preço, estoque, disponibilidade e condições de pagamento.`,prompt:m,icon:o,copied:e===`units`,onCopy:()=>void y(`units`,m)}),(0,p.jsx)(v,{title:`Prompt de Empreendimentos`,description:`Para apresentações, memoriais, folders e materiais comerciais completos.`,prompt:h,icon:t,copied:e===`enterprise`,onCopy:()=>void y(`enterprise`,h)}),(0,p.jsx)(v,{title:`Prompt de Landing Persuasiva`,description:`Extrai narrativa, frases e blocos comerciais da apresentação da construtora.`,prompt:g,icon:c,copied:e===`landing`,onCopy:()=>void y(`landing`,g)}),(0,p.jsx)(v,{title:`Kit do Indicador`,description:`Analisa book + tabela e gera o produto, roteiro SDR e perguntas em JSON revisável.`,prompt:_,icon:s,copied:e===`indicator`,onCopy:()=>void y(`indicator`,_)})]}),(0,p.jsxs)(`article`,{style:{background:`#101012`,border:`1px solid #493a22`,borderRadius:12,padding:22,display:`grid`,gap:16},children:[(0,p.jsxs)(`div`,{style:{display:`flex`,gap:12,alignItems:`flex-start`},children:[(0,p.jsx)(`div`,{style:{width:42,height:42,borderRadius:10,background:`rgba(213,164,87,.12)`,color:`#d5a457`,display:`grid`,placeItems:`center`,flex:`0 0 auto`},children:(0,p.jsx)(r,{size:21})}),(0,p.jsxs)(`div`,{children:[(0,p.jsx)(`h2`,{style:{margin:0,fontSize:18},children:`Prompt de artigo para o Blog`}),(0,p.jsx)(`p`,{style:{margin:`6px 0 0`,color:`#92929d`,lineHeight:1.5,fontSize:13},children:`Gera texto escaneável, SEO, blocos, plano de imagens, CTA e fontes em um único JSON importável.`})]})]}),(0,p.jsxs)(`label`,{style:{color:`#c9c9cf`,fontSize:12,display:`grid`,gap:6},children:[`Qual é the tema?`,(0,p.jsx)(`textarea`,{value:a,onChange:e=>u(e.target.value),rows:2,placeholder:`Ex.: Como a Selic influencia o financiamento imobiliário e as decisões do investidor em 2026`,style:{width:`100%`,boxSizing:`border-box`,background:`#09090b`,border:`1px solid #3a3a42`,borderRadius:8,color:`#f4f4f5`,padding:10,resize:`none`}})]}),(0,p.jsxs)(`button`,{onClick:()=>void y(`blog`,d(a)),style:{height:42,border:e===`blog`?`1px solid #218b57`:`1px solid #8e672e`,borderRadius:8,background:e===`blog`?`#123021`:`#d5a457`,color:e===`blog`?`#76dfa8`:`#080808`,fontWeight:800,cursor:`pointer`,display:`flex`,justifyContent:`center`,alignItems:`center`,gap:8},children:[(0,p.jsx)(l,{size:17}),e===`blog`?`Prompt copiado`:`Copiar prompt para este tema`]}),(0,p.jsx)(`small`,{style:{color:`#777782`,fontSize:11},children:`Na outra IA: cole o prompt, aguarde o JSON, copie a resposta e use “Importar pacote da IA” no editor do Blog.`})]}),(0,p.jsxs)(`div`,{style:{display:`flex`,gap:8,alignItems:`center`,color:`#686872`,fontSize:12},children:[(0,p.jsx)(c,{size:15}),` Versão 2 — compatível com o padrão interno de empreendimentos e unidades.`]})]})}export{y as default};
