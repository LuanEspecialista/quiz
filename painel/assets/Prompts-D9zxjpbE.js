import{r as e}from"./rolldown-runtime-hePW80VL.js";import{Bt as t,S as n,Ut as r,Zt as i,jt as a,nt as o,xt as s,yt as c}from"./vendor-icons-CfDogOYi.js";import{t as l}from"./vendor-react-CrcOf3wO.js";import{t as u}from"./blogEditorial-C7tOeeGb.js";var d=e(i(),1),f=l(),p=`Você é um auditor de tabelas imobiliárias. Analise integralmente o PDF ou imagem anexado e transforme a tabela de vendas em dados estruturados, sem inventar, completar por suposição ou arredondar valores.
...
Antes de responder, confira novamente a contagem de linhas, códigos repetidos, torres e totais financeiros. resumo_oficial deve reproduzir os números impressos, sem ser recalculado a partir do array. A soma de unidades + unidades_pendentes deve fechar exatamente com o resumo do escopo processado. Use PRONTO_PARA_IMPORTAR quando existir ao menos uma unidade válida e todas as contagens estiverem conciliadas; preserve linhas reais incompletas em unidades_pendentes. Use PENDENTE_INFORMACAO quando a contagem não fechar, nenhuma unidade puder ser importada ou uma dúvida global impedir interpretar o documento.`,m=`Você é um auditor técnico de memoriais, apresentações e materiais comerciais imobiliários. Analise integralmente todos os PDFs ou imagens anexados e estruture o empreendimento sem inventar informações.
...
Antes de responder, faça uma segunda leitura para conferir números, nomes próprios, datas, contagens, áreas e registro de incorporação. Não resuma listas e nunca devolva apenas exemplos.`,h=`Você é um estrategista de conteúdo imobiliário e auditor de informações. Analise integralmente a apresentação da construtora e transforme somente o que estiver comprovado no material em conteúdo persuasivo para uma landing page de vendas.
...
Use layout_sugerido editorial, imersivo ou investidor. Releia o material e remova afirmações que não sejam sustentadas pela apresentação.`;function g({title:e,description:t,prompt:n,icon:r,copied:i,onCopy:o}){return(0,f.jsxs)(`article`,{style:{background:`#101012`,border:`1px solid #26262b`,borderRadius:12,padding:22,display:`grid`,gap:16},children:[(0,f.jsxs)(`div`,{style:{display:`flex`,gap:12,alignItems:`flex-start`},children:[(0,f.jsx)(`div`,{style:{width:42,height:42,borderRadius:10,background:`rgba(213,164,87,.12)`,color:`#d5a457`,display:`grid`,placeItems:`center`,flex:`0 0 auto`},children:(0,f.jsx)(r,{size:21})}),(0,f.jsxs)(`div`,{children:[(0,f.jsx)(`h2`,{style:{margin:0,fontSize:18},children:e}),(0,f.jsx)(`p`,{style:{margin:`6px 0 0`,color:`#92929d`,lineHeight:1.5,fontSize:13},children:t})]})]}),(0,f.jsx)(`div`,{style:{padding:`12px 14px`,borderRadius:8,background:`#0a0a0b`,border:`1px solid #202024`,color:`#777782`,fontSize:12,lineHeight:1.55,height:112,overflow:`hidden`,whiteSpace:`pre-wrap`,maskImage:`linear-gradient(#000 55%, transparent)`},children:n}),(0,f.jsxs)(`button`,{onClick:o,style:{height:42,border:i?`1px solid #218b57`:`1px solid #8e672e`,borderRadius:8,background:i?`#123021`:`#d5a457`,color:i?`#76dfa8`:`#080808`,fontWeight:800,cursor:`pointer`,display:`flex`,justifyContent:`center`,alignItems:`center`,gap:8},children:[i?(0,f.jsx)(a,{size:17}):(0,f.jsx)(c,{size:17}),i?`Prompt copiado`:`Copiar prompt completo`]})]})}function _(){let[e,i]=(0,d.useState)(null),[a,l]=(0,d.useState)(``),_=async(e,t)=>{if(navigator.clipboard?.writeText)await navigator.clipboard.writeText(t);else{let e=document.createElement(`textarea`);e.value=t,e.style.position=`fixed`,e.style.opacity=`0`,document.body.appendChild(e),e.select(),document.execCommand(`copy`),e.remove()}i(e),window.setTimeout(()=>i(t=>t===e?null:t),2200)};return(0,f.jsxs)(`section`,{style:{maxWidth:1120,margin:`0 auto`,display:`grid`,gap:22},children:[(0,f.jsxs)(`header`,{children:[(0,f.jsx)(`div`,{style:{color:`#d5a457`,textTransform:`uppercase`,letterSpacing:`.12em`,fontSize:11,fontWeight:800},children:`Inteligência de importação`}),(0,f.jsx)(`h1`,{style:{margin:`7px 0`,fontSize:28},children:`Central de Prompts`}),(0,f.jsx)(`p`,{style:{margin:0,color:`#9696a1`,maxWidth:760,lineHeight:1.55},children:`Use modelos preparados para entregar ao sistema exatamente a estrutura esperada, sem preenchimento manual repetitivo.`})]}),(0,f.jsxs)(`div`,{style:{display:`flex`,gap:9,alignItems:`center`,color:`#8fa695`,background:`#0e1712`,border:`1px solid #1e3b2a`,borderRadius:9,padding:`11px 14px`,fontSize:12},children:[(0,f.jsx)(n,{size:17}),` O resultado ainda deve ser revisado antes da importação quando o PDF estiver borrado, cortado ou tiver cálculos divergentes.`]}),(0,f.jsxs)(`div`,{style:{display:`grid`,gridTemplateColumns:`repeat(auto-fit, minmax(330px, 1fr))`,gap:16},children:[(0,f.jsx)(g,{title:`Prompt de Unidades`,description:`Para tabelas de preço, estoque, disponibilidade e condições de pagamento.`,prompt:p,icon:o,copied:e===`units`,onCopy:()=>void _(`units`,p)}),(0,f.jsx)(g,{title:`Prompt de Empreendimentos`,description:`Para apresentações, memoriais, folders e materiais comerciais completos.`,prompt:m,icon:t,copied:e===`enterprise`,onCopy:()=>void _(`enterprise`,m)}),(0,f.jsx)(g,{title:`Prompt de Landing Persuasiva`,description:`Extrai narrativa, frases e blocos comerciais da apresentação da construtora.`,prompt:h,icon:s,copied:e===`landing`,onCopy:()=>void _(`landing`,h)})]}),(0,f.jsxs)(`section`,{style:{background:`#101012`,border:`1px solid #493a22`,borderRadius:12,padding:22,display:`grid`,gap:14},children:[(0,f.jsxs)(`div`,{style:{display:`flex`,gap:12,alignItems:`flex-start`},children:[(0,f.jsx)(`div`,{style:{width:42,height:42,borderRadius:10,background:`rgba(213,164,87,.12)`,color:`#d5a457`,display:`grid`,placeItems:`center`},children:(0,f.jsx)(r,{size:21})}),(0,f.jsxs)(`div`,{children:[(0,f.jsx)(`h2`,{style:{margin:0,fontSize:18},children:`Prompt de artigo para o Blog`}),(0,f.jsx)(`p`,{style:{margin:`6px 0 0`,color:`#92929d`,lineHeight:1.5,fontSize:13},children:`Gera texto escaneável, SEO, blocos, plano de imagens, CTA e fontes em um único JSON importável.`})]})]}),(0,f.jsxs)(`label`,{style:{color:`#c9c9cf`,fontSize:12},children:[`Qual é o tema?`,(0,f.jsx)(`textarea`,{value:a,onChange:e=>l(e.target.value),rows:3,placeholder:`Ex.: Como a Selic influencia o financiamento imobiliário e as decisões do investidor em 2026`,style:{width:`100%`,marginTop:6,boxSizing:`border-box`,background:`#09090b`,border:`1px solid #3a3a42`,borderRadius:8,color:`#f4f4f5`,padding:11}})]}),(0,f.jsxs)(`button`,{onClick:()=>void _(`blog`,u(a)),style:{height:42,border:e===`blog`?`1px solid #218b57`:`1px solid #8e672e`,borderRadius:8,background:e===`blog`?`#123021`:`#d5a457`,color:e===`blog`?`#76dfa8`:`#080808`,fontWeight:800,cursor:`pointer`,display:`flex`,justifyContent:`center`,alignItems:`center`,gap:8},children:[(0,f.jsx)(c,{size:17}),e===`blog`?`Prompt copiado`:`Copiar prompt para este tema`]}),(0,f.jsx)(`small`,{style:{color:`#777782`},children:`Na outra IA: cole o prompt, aguarde o JSON, copie a resposta e use “Importar pacote da IA” no editor do Blog.`})]}),(0,f.jsxs)(`div`,{style:{display:`flex`,gap:8,alignItems:`center`,color:`#686872`,fontSize:12},children:[(0,f.jsx)(s,{size:15}),` Versão 2 — compatível com o padrão interno de empreendimentos e unidades.`]})]})}export{_ as default};